...
class BiEncoderTrainer(object):
    ...
    def __init__(self, args):
        ...
        # print('load for teacher model')
        # teacher_model_file = '../DPR_distill/results/movieQA_teacher/dpr_biencoder.2.18834'
        # teacher_saved_state = load_states_from_checkpoint(teacher_model_file)
        # model.load_state_dict(teacher_saved_state.model_dict)
        # # student model freeze all layers exclude word embedding layer
        # for name, param in model.named_parameters(): 
        #     if 'word_embeddings' not in name:
        #         param.requires_grad = False
        # print('load for teacher model Done')  
